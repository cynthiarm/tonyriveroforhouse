...
try {
    ...
    if($type == '1' )
    {
        ...
        $emailLang = 'Email:';
        $messageLang = 'Message:';
        $subject = 'Anyone interested in learning more about the campaign, do not miss this opportunity!';
        $fromname = "Anyone interested in learning more about the campaign, do not miss this opportunity!";
    }
    else if($type == '2'){
        $hello = 'Hola';
        $nameLang = 'Nombre:';
