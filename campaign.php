...
// SMTP configuration
    ...
    $mail->setFrom('noreply@tonyriveroforhouse.com', 'Someone interested in learning more about the campaign, do not miss this opportunity!');
    $mail->addAddress('tonyrivero@ymail.com');

    // Email subject and body
    $mail->isHTML(true);
    $mail->Subject = 'Someone interested in learning more about the campaign, do not miss this opportunity!';
    $mail->Body = '<html><body>';
    ...
    $mail->Body .= "<tr style='background: #ed1c24;'><td align='right'><strong>$messageLang</strong> </td><td>" .  trim($_POST["message"]) . "</td></tr>";
   // $mail->Body .= "<tr><td align='right'><strong>$messageLang</strong> </td><td>" .  trim($_POST["message"]) . "</td></tr>";
    ...
    echo "<div style='color: #ffffff;margin-bottom: 15px;font-size: 15px;'>Message could not be sent. Mailer Error: {$mail->ErrorInfo}";
}
?>